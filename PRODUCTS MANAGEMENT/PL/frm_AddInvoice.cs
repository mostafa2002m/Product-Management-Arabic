    ...
    public partial class frm_AddInvoice : Form
    {
       ...
       private void txtqty_KeyDown(object sender, KeyEventArgs e)
        ...
        private void txtqty_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (!char.IsDigit(e.KeyChar) && e.KeyChar != 8 && e.KeyChar!=46  && e.KeyChar != Convert.ToChar(CultureInfo.CurrentCulture.NumberFormat.NumberDecimalSeparator))
            {
                try
                {
                    e.Handled = true;
        ...
        private void btnSaveOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Ins == true)
                {
                    ...
                    if (rdbCash.Checked)
                    {
                        Add_Payment_Cash("سداد فاتورة مشتريات" );
            ...
            catch (Exception ex) when (ex.Message.Equals("أدخل بيانات المورد"))
            {

                MessageBox.Show("من فضلك أدخل بيانات المورد");
            }
        ...
        private void PrintInvoice()
        {
            try
            {
                if (MessageBox.Show(@"طباعة الفاتورة؟", @"طباعة فاتورة مشتريات", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes) 
