...
namespace PRODUCTS_MANAGEMENT.PL
{
    public partial class FrmROrder : Form
    {
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(@"هل تريد الخروج بدون حفظ بيانات الفاتوره", @"تحذير", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                    this.Close();
                else
                    return;
            }
        ...
        private void FrmROrder_Load(object sender, EventArgs e)
        {
        ...
        private void btnSaveOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Ins == true)
                {
                    if (rdbCash.Checked)
                    {
                        ...
                        //else
                        //{
                        Add_Payment_Cash("سداد مردودات مبيعات");
                        MessageBox.Show(@"تم السداد نقدا");
                    }
                }
            ...
            catch (Exception ex) when (ex.Message.Equals(cls_Controls.InvalidCustomerData))
            {

                MessageBox.Show(cls_Controls.CheckCustomerData);
            }
